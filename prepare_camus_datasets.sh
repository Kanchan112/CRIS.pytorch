...
testing_source='camus_testing'

python ../tools/folder2lmdb.py -j anns/$dataset_name$version/testA.json -i images/$testing_source/ -m masks/$testing_source -o lmdb/$dataset_name$version
python ../tools/folder2lmdb.py -j anns/$dataset_name$version/testB.json -i images/$testing_source/ -m masks/$testing_source -o lmdb/$dataset_name$version
